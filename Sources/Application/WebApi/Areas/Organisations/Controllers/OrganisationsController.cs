...
using Mmu.CleanArchitecture.UseCases.Areas.Organisations.LoadAllOrganisations.Interactors;

namespace Mmu.CleanArchitecture.WebApi.Areas.Organisations.Controllers
{
    [Authorize]
    [ApiController]
